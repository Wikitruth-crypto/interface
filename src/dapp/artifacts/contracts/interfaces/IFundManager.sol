...
interface IFundManager{
    ...
    function depositOrderAmount(uint256 boxId_, address buyer_, uint256 amount_) external;
    // EXCHANGE
    function depositConfidentialityFee( uint256 boxId_, address buyer_, uint256 amount_) external;
