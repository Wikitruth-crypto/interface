...
//         set((state) => {
//             const chainSecrets = state.secrets[CHAIN_ID];
...
//         const baseState = get()._getOrCreateSecretState(verifiedAddress, CHAIN_ID);
...
//                 secrets: {
//                     ...state.secrets,
//                     [CHAIN_ID]: chainSecrets,
//                 },
//             };
//         });

//         persistSecretStateEncrypted(verifiedAddress, CHAIN_ID, stateWithLogs);
...
//         const normalizedSpender = spender.toLowerCase();
//         const key = normalizeAddress(verifiedAddress);
//         const secretState = get().secrets[CHAIN_ID]?.[key];
...
//         persistSecretStateEncrypted(verifiedAddress, CHAIN_ID, updatedState);
...
//         persistSecretStateEncrypted(verifiedAddress, CHAIN_ID, {
//             ...updatedState,
//             auditLogs: baseState.auditLogs,
//         });
...
//                     if (isCurrentAccount && CHAIN_ID === cid) {
...
//         if (!verifiedAddress || CHAIN_ID === undefined || CHAIN_ID === null) {
//             return [];
//         }
...
//             if (currentAccount && CHAIN_ID !== undefined && CHAIN_ID !== null) {
//                 const normalized = normalizeAddress(currentAccount);
//                 const existing = mergedSecrets[CHAIN_ID]?.[normalized];
//                 if (existing?.siwe) {
