        ...
        <div className={cn(
            ...
            <div className={cn(
                ...
                <div className="w-full">
                    <div className={cn(
                        "bg-white/20 rounded",
                        // 响应式高度，模拟 text-xs sm:text-sm md:text-md 的两行文字
                        // text-xs: ~12px, text-sm: ~14px, text-md: ~16px
                        // leading-tight: ~1.25, leading-normal: ~1.5
                        // 两行高度：text-xs*1.25*2=30px, text-sm*1.25*2=35px, text-md*1.5*2=48px
                        "h-[30px] sm:h-[35px] md:h-[48px]",
                        "w-full", // 标题占满宽度
                        shimmerClass
                    )} />
                </div>
