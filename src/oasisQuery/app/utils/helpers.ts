...
// Removed isValidRoflAppId - ROFL support removed
// Removed isValidProposalId - consensus proposals not supported
...
export const getAccountSize = (value: bigint) => {
  if (value === BigInt(0)) {
    return '-'
  } else if (value >= BigInt(100_000_000_000_000_000)) {
    return 'XXL'
  } else if (value >= BigInt(50_000_000_000_000_000) && value <= BigInt(99_999_999_999_999_999)) {
    return 'XL'
  } else if (value >= BigInt(25_000_000_000_000_000) && value <= BigInt(49_999_999_999_999_999)) {
    return 'L'
  } else if (value >= BigInt(1_000_000_000_000_000) && value <= BigInt(24_999_999_999_999_999)) {
    return 'M'
  } else if (value >= BigInt(500_000_000_000_000) && value <= BigInt(999_999_999_999_999)) {
    return 'S'
  } else if (value >= BigInt(100_000_000_000_000) && value <= BigInt(499_999_999_999_999)) {
    return 'XS'
  } else {
    return 'XXS'
  }
