import{i as e,p as t,s as i,j as o,M as a,S as r,R as s,k as n,l as c,m as l,x as w,A as d,n as u,o as p,C as m,q as h,u as v,v as g,E as f,O as b,y,z as x,B as k,D as C,T as S,F as R,G as N,I as O}from"./core-BxRK3fCK.js";import{c as T,n as A,r as W,o as $,U as E}from"./index-CijAyTdt.js";import"./index-DzmPGAS5.js";import"./events-1gxUSAb9.js";import"./index.es-_2ncsC1s.js";const I=t({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),P=e({state:I,subscribe:e=>o(I,()=>e(I)),subscribeKey:(e,t)=>i(I,e,t),showTooltip({message:e,triggerRect:t,variant:i}){I.open=!0,I.message=e,I.triggerRect=t,I.variant=i},hide(){I.open=!1,I.message="",I.triggerRect={width:0,height:0,top:0,left:0}}}),j={isUnsupportedChainView:()=>"UnsupportedChain"===s.state.view||"SwitchNetwork"===s.state.view&&s.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void a.shake();await r.isSIWXCloseDisabled()?a.shake():a.close()}},D=n`
  :host {
    display: block;
...
`;var M=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let _=class extends l{constructor(){super(...arguments),this.size="md",this.disabled=!1,this.icon="copy",this.iconColor="inherit"}render(){const e="lg"===this.size?"--wui-border-radius-xs":"--wui-border-radius-xxs",t="lg"===this.size?"--wui-spacing-1xs":"--wui-spacing-2xs";return this.style.cssText=`\n    --local-border-radius: var(${e});\n    --local-padding: var(${t});\n`,w`
    ...
    `}};_.styles=[c,u,p,Y],M([A()],_.prototype,"size",void 0),M([A({type:Boolean})],_.prototype,"disabled",void 0),M([A()],_.prototype,"icon",void 0),M([A()],_.prototype,"iconColor",void 0),_=M([T("wui-icon-link")],_);const G=n`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`;var q=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let F=class extends l{constructor(){super(...arguments),this.imageSrc=""}render(){return w`<button>
    ...
    ></wui-icon-box>`}};F.styles=[c,u,p,G],q([A()],F.prototype,"imageSrc",void 0),F=q([T("wui-select")],F);const J=n`
  :host {
    height: 64px;
  }
...
`;var we=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let de=class extends l{constructor(){super(),this.unsubscribe=[],this.open=P.state.open,this.message=P.state.message,this.triggerRect=P.state.triggerRect,this.variant=P.state.variant,this.unsubscribe.push(P.subscribe(e=>{this.open=e.open,this.message=e.message,this.triggerRect=e.triggerRect,this.variant=e.variant}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){this.dataset.variant=this.variant;const e=this.triggerRect.top,t=this.triggerRect.left;return this.style.cssText=`\n    --w3m-tooltip-top: ${e}px;\n    --w3m-tooltip-left: ${t}px;\n    --w3m-tooltip-parent-width: ${this.triggerRect.width/2}px;\n    --w3m-tooltip-display: ${this.open?"flex":"none"};\n    --w3m-tooltip-opacity: ${this.open?1:0};\n    `,w`<wui-flex>
